...
import __pure_tab from 'web-crud/src/form/web/WFormTab';
import __pdf_reader from './src/components/pdf-reader';
...
import __m_progress from '../../pkgs/web/mobile/src/m-progress';
...
declare global {
  ...
  function base<T extends Record<string, any>>(effect: {
    ...
    children?: any;
    render: () => void;
  }, props?: any) => ReactElement, props?: any): void;
  ...
  namespace JSX {
    interface IntrinsicElements {
      ...
      "m-progress": ExtractProps<typeof __m_progress>;
