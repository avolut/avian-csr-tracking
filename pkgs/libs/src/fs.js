...
export const emptydir = fs.emptydir
export const createFile = fs.createFile
export const createFileSync = fs.createFileSync
export const ensureFile = fs.ensureFile
export const ensureFileSync = fs.ensureFileSync
export const createLink = fs.createLink
export const createLinkSync = fs.createLinkSync
export const ensureLink = fs.ensureLink
export const ensureLinkSync = fs.ensureLinkSync
export const createSymlink = fs.createSymlink
export const createSymlinkSync = fs.createSymlinkSync
